...
<title>Messages — NexShop Vendeur</title>
...
@endphp
<body class="msg-chat-fullscreen nx-msg-mobile--seller-index">
...
<div class="msg-app-page nx-messaging nx-msg-full nx-messaging--edge">
  <div class="msg-layout">
    <div class="msg-list-col">
      <div class="msg-list-header">
        ...
        <div class="msg-search-wrap">
          ...
          <input type="search" class="msg-search" id="nx-conv-filter" placeholder="Rechercher un acheteur…" autocomplete="off">
        </div>
      </div>
      <div class="msg-list">
        @forelse($conversations as $c)
          @php $other = $c->otherParty(auth()->user()); @endphp
          <a href="{{ route('vendeur.messages.show', $c) }}" class="msg-list-item" data-filter-name="{{ mb_strtolower($other?->nom ?? '') }}">
            ...
            <div class="msg-list-body">
              <div class="msg-list-name">{{ $other?->nom ?? 'Client' }}</div>
              <div class="msg-list-preview">
                ...
                @else
                  {{ \Illuminate\Support\Str::limit($c->latestMessage?->body ?? 'Pas encore de message', 44) }}
                @endif
              </div>
            </div>
        ...
        @empty
          <div class="msg-pane-empty-inner">
            ...
            <div class="msg-list-name" style="margin-top:8px">Boîte vide</div>
            <p style="font-size:13px;color:#9ca3af;margin:8px 0 0;line-height:1.45">Dès qu’un acheteur vous écrit, la conversation apparaît ici.</p>
          </div>
        @endforelse
      </div>
    </div>
    ...
    <div class="msg-pane-empty">
      ...
      <h3>Votre messagerie NexShop</h3>
      <p>Sélectionnez une conversation à gauche pour lire et répondre aux messages.</p>
    </div>
  </div>
</div>
